...
bash ~/vauban/setup.sh ~/now-on-tap      npm
bash ~/vauban/setup.sh ~/podcast         pip
bash ~/vauban/setup.sh ~/pj-sora         pip
bash ~/vauban/setup.sh ~/brewdrop        none
bash ~/vauban/setup.sh ~/delivery_route  none   # delivery-app
bash ~/vauban/setup.sh ~/delivery_log    none
bash ~/vauban/setup.sh ~/mediiiiium      none   # mediiiiium-web
```
